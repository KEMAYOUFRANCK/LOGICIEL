...
def main():
    ...
    st.markdown("""<h1 class="animated-title">BIENVENUE DANS L'ESPACE D'ANALYSE DES DYNAMIQUES MACROECONMIQUES DE L'ECONOMIE DU RWANDA</h1>""", unsafe_allow_html=True)
    ...
    st.image("R (2).jpeg", caption="Drapeau du RWANDA", use_container_width=True)  # Changement ici

    st.title("Cette page, fruit du groupe constitué de KEMAYOU NGASSA Franck et de GALI MANDO JEAN MARIE, vous donne une vue sur la base de données utilisée pour faire des analyses, la description des différentes chroniques retenues, la modélisation ARDL et les simulations.")
